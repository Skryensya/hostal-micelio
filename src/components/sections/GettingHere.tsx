      ...
      <div className="grid grid-cols-12 gap-4 md:gap-12">
        <div className="col-span-12 text-lg lg:col-span-5">
          <p className="mb-4">
            ...
            <a href="https://maps.app.goo.gl/5v4wGHi4YDYywrHw9" target="_blank">
              Francisco Bilbao 969
            </a>
            , en el corazón de Villarrica. Su ubicación central es uno de sus
            principales atractivos, ya que está a pocos pasos de los terminales
            de transporte y del centro de la ciudad. Esto permite a nuestros
            huéspedes acceder fácilmente a las diversas atracciones y servicios
            que Villarrica tiene para ofrecer.
          </p>
          <p>
