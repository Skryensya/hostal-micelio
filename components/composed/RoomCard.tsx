    ...
    <Card className="flex flex-col h-full w-full">
      <div className="relative w-full aspect-[4/3] overflow-hidden">
        <Image
          ...
          layout="fill"
          objectFit="cover"
          className="transition-transform duration-500 hover:scale-105 rounded-t-xl"
        />
      </div>
    ...
    return (
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger asChild>
          <div className="flex flex-col h-full w-full shadow-lg border rounded-xl cursor-pointer">
            <CardContent />
          </div>
        </DialogTrigger>
        <DialogContent className="w-full max-w-5xl mx-auto max-h-[85vh] overflow-hidden">
          <DialogHeader>
          ...
          <DialogDescription className="space-y-4 overflow-hidden">
            ...
            <ScrollArea className="h-[20vh]">{renderRoomDetails()}</ScrollArea>
          </DialogDescription>
        </DialogContent>
      </Dialog>
    );
