...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-neutral-300",
  {
    variants: {
      variant: {
        default:
          "bg-secondary-light text-neutral-50 shadow hover:bg-secondary-light-90 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50/90",
        destructive:
      ...
      size: {
        default: "h-10 rounded-standar px-6 py-4",
        sm: "h-8 rounded-standar px-3 text-xs",
        lg: "h-12 rounded-standar px-8",
        icon: "h-9 w-9",
      },
    },
    defaultVariants: {
